      ...
      <div className={`auth-card ${fadeIn ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
        <div className="text-center">
          ...
          <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/register" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors duration-300 hover:underline">
              Sign up now
            </Link>          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember"
                type="checkbox"
                className="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-700 rounded transition-colors duration-200 cursor-pointer"
              />
              <label htmlFor="remember" className="ml-2 block text-sm text-gray-700 dark:text-gray-300 transition-colors duration-200 cursor-pointer hover:text-indigo-600 dark:hover:text-indigo-400">
                Remember me              </label>
            </div>
            
            <div className="text-sm">
              <Link to="/forgot-password" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors duration-200 hover:underline">
          ...
          <div className="flex items-center justify-center mt-6 space-x-2">
            <span className="h-px bg-gray-300 dark:bg-gray-600 w-1/3"></span>
            <Link to="/" className="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-200">
              Back to home
            </Link>
            <span className="h-px bg-gray-300 dark:bg-gray-600 w-1/3"></span>
          </div>
